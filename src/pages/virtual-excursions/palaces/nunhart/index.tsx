...
export const NunhartPalace = () => (
  <div className='excursion'>
    ...
    <div className='excursion__map-wrapper'>
      <Iframe
        height='359'
        src='https://www.google.com/maps/d/embed?mid=1OuqIflCYXpSTmczR3ToqBUNg5kzChcg&ehbc=2E312F'
        width='570'
      />
    ...
    <div className='excursion__content'>
      ...
      <p className='excursion__text'>
        ...
        расположилась система искусственных прудов. Известно, что дом Нонхарта выдержал атаки шведов
      ...
      <p className='excursion__text'>
        Дом небольшой, симметричный, всего 15 х 34 метра. Здание построено из кирпича - «пальчатки»,
        стены имеют толщину 1,5 метра. Дом двухэтажный, прямоугольной формы. Центральная часть
        строения представляет собой трехэтажную башню, выступающую из плоскости фасада. В башне
        находится главный вход, над которым помещен фамильный герб владельца. Из башни можно было
        спуститься в подвалы, которые занимали всю площадь под домом. На первом этаже располагались
        различные службы, на втором и третьем – комнаты для проживания семьи. В большой столовой
        можно было посидеть у камина, выполненного в виде декоративной башни. Над входом в столовую
        был расположен балкон для музыкантов. Отдельная дверь выходила в сад.
      </p>
      <p className='excursion__text'>
        ...
        здания, то специалисты зафиксировали, что степень поражения здания составляет всего лишь 30%
        - и это несмотря на то, что возраст строения к 2000 году – почти 400 лет!
      </p>
      <p className='excursion__text'>
