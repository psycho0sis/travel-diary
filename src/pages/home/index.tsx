  ...
  <div>
    ...
    <div className='mainPage__content'>
      <p className='mainPage__text'>
        ...
        локацию, путешествия не выглядят чем-то особенным и уникальным.
      </p>
      <Title fontSize={22}>Цель дневника путешествия</Title>
      <p className='mainPage__text'>
        Именно поэтому путешественники старались получить максимум, в том числе и запомнить все свои
        переживания и ощущения. Помимо этого существовал и исследовательский интерес, потребность в
        межкультурном обмене, для чего тоже было актуальным фиксировать происходящее. Так или иначе,
        дневники путешествий были практически неотъемлемой частью поездки. Многие из них до сих пор
